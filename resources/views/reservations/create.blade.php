...
<div class="container">
	<h1>Make Laboratory Reservation</h1>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<div class="input-group date" id="datetimepicker2" data-target-input="nearest">
						<input name='starts_at' type="text" class="form-control datetimepicker-input" data-target="#datetimepicker2" required/>
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<div class="input-group date" id="datetimepicker3" data-target-input="nearest">
						<input name='ends_at' type="text" class="form-control datetimepicker-input" data-target="#datetimepicker3" required/>
